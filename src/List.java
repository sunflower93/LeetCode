...
//        ListNode list = new ListNode(array[0]);   //创建二叉树
//        ListNode list1 = new ListNode(array1[0]);
//        ListNode list11 = new ListNode(array11[0]);
//        for (int i = 1; i < array.length; i++) {
//            list.insert(list, array[i]);       //向二叉树中插入数据
//        }
//        for (int i = 1; i < array1.length; i++) {
//            list1.insert(list1, array1[i]);       //向二叉树中插入数据
//        }
//        for (int i = 1; i < array11.length; i++) {
//            list11.insert(list11, array11[i]);       //向二叉树中插入数据
//        }
//        ListNode l = list;
//        ListNode ll = list1;
//        ListNode lll = list11;
...
//        }
        ...
        for (int i = 1; i < arrays1.length; i++) {
            sortlist1.insert(sortlist1, arrays1[i]);       //向二叉树中插入数据
        }
        for (int i = 1; i < arrays2.length; i++) {
            sortlist2.insert(sortlist2, arrays2[i]);       //向二叉树中插入数据
        }
