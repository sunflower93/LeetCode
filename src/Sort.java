...
public class Sort {
    ...
    public void bubbleSort(int[] arrays) {                     //Ã°ÅİÅÅĞò
    ...
    public void selectSort(int []arrays) {              //Ñ¡ÔñÅÅĞò
        int min = 0;
        for (int i = 0; i < arrays.length; i++) {
            min = i;
    ...
    public void insertionSort(int []arrays) {                //²åÈëÅÅĞò
    ...
    public void shellSort(int []arrays) {                    //Ï£¶ûÅÅĞò
        int i,j;
        int temp;
        int h = 1;
    ...
    private void swap(int []arrays, int i, int j) {                            //½»»»º¯Êı
        int t = arrays[i];
        arrays[i] = arrays[j];
        arrays[j] = t;
    }

    private void subsort(int []arrays, int start, int end) {                    //¿ìÅÅ×Óº¯Êı
        if (start < end) {
    ...
    public void quickSort(int []arrays) {                          //¿ìËÙÅÅĞò
        subsort(arrays, 0, arrays.length - 1);
    }

    public void binaryinsertSort(int []arrays) {                 //ÕÛ°ë²åÈëÅÅĞò
        for (int i = 1; i < arrays.length; i++) {
            int temp = arrays[i];
            int low = 0;
            int high = i - 1;
    ...
    private void merge(int []arrays, int left, int center, int right) {       //¹é²¢
    ...
    private void sort(int []arrays,int start,int end) {             //»®·Ö
        int mid = (start + end) / 2;
    ...
    public void mergeSort(int []arrays) {                    //¹é²¢ÅÅĞò
