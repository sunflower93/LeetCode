...
public class BinaryTreePreorder {
    ...
    public  static void preOrder2(TreeNode root) {    //先序遍历非递归
    ...
    public static void inOrder2(TreeNode root) {    //中序遍历非递归
        Stack<TreeNode> stack = new Stack<TreeNode>();
        while (root != null || !stack.empty()) {
            while (root != null) {
                stack.push(root);
    ...
    public static void postOrder2(TreeNode root) {   //后根遍历非递归
        Stack<TreeNode> stack = new Stack<TreeNode>();
    ...
    public static boolean isSameTree(TreeNode p, TreeNode q) {       //比较两个二叉树是否相等
        if (p != null && q != null) {
    ...
    public static TreeNode find(TreeNode root, int x) {         //查找树
        while (root != null) {
    ...
    public static int min(TreeNode root) {                    //查找最小元素
    ...
    public static int max(TreeNode root) {                    //查找最大元素
    ...
    private static TreeNode getSuccessor(TreeNode delNode) {                         //寻找删除节点的后继节点
    ...
    public static void delete(TreeNode root, int key) {                        //删除节点
    ...
    public static void main(String[] args) {
        ...
        for (int i = 1; i < array1.length; i++) {
            root.insert(root1, array1[i]);       //向二叉树中插入数据
        }
